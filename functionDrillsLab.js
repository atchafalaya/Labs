...
function add (one, two){
  parsedOne = parseInt(one)
  parsedTwo = parseInt(two)

  sumOne = parsedOne + parsedTwo
  return sumOne
...
let nameGreeting = nameCheck("Jim")
...
console.log(emailCheck("john@aol.com"))
